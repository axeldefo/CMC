...
export default function Total ({defaultStartDate, defaultEndDate, allForums}) {
    ...
    const handleWithOthers = async () => {
        ...
        try {
            const response = await fetch(`/api/cmc/total?${queryParams}`, {
                method : 'GET',
                headers: {
    ...
    const options = {
        ...
        title: {
            text: 'Total points of the top 5 users per day',
            style: {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <figure className="highcharts-figure" style={{ textAlign: 'center', padding: '20px' }}>
                <h1 className="text-3xl mb-4">Total points of the top 5 users per day</h1>

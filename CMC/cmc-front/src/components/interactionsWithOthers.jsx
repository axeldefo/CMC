...
export default function InteractionsWithOthers ({defaultStartDate, defaultEndDate, allForums}) {
    ...
    const handleWithOthers = async () => {
        ...
        try {
            const response = await fetch(`/api/cmc/others?${queryParams}`, {
                method : 'GET',
                headers: {
    ...
    const options = {
        ...
        title: {
            text: 'Interactions with others of the top 5 users per day',
            style: {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <figure className="highcharts-figure" style={{ textAlign: 'center', padding: '20px' }}>
                <h1 className="text-3xl mb-4">Users Interactions with others per day</h1>
